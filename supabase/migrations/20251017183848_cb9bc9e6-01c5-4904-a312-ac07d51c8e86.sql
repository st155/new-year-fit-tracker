-- Fix security definer view by removing SECURITY DEFINER
-- Views don't need SECURITY DEFINER, they use the permissions of the querying user

-- Drop and recreate view without SECURITY DEFINER
DROP VIEW IF EXISTS client_unified_metrics;

CREATE VIEW client_unified_metrics AS
