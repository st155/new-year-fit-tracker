  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        trainer: {
          bg: "hsl(var(--trainer-bg))",
          card: "hsl(var(--trainer-card-bg))",
          hover: "hsl(var(--trainer-card-hover))",
          orange: "hsl(var(--trainer-accent-orange))",
          green: "hsl(var(--trainer-accent-green))",
          blue: "hsl(var(--trainer-accent-blue))",
          slate: "hsl(var(--trainer-accent-slate))",
        },
        gold: "hsl(var(--gold))",
