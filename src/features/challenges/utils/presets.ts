/**
 * Challenge Presets
 * Predefined challenge configurations for quick setup
 */
 ...
 */
export function getPresetsByCategory(category: string): ChallengePreset[] {
  return CHALLENGE_PRESETS.filter(p => p.category === category);
}
