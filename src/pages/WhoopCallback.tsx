...
export default function WhoopCallback() {
  ...
  const exchangeToken = async (code: string, state: string | null) => {
    try {
      ...
      console.log('🔄 [WhoopCallback] Exchanging code for tokens...');
      ...
      console.log('✅ [WhoopCallback] Token exchange successful');
      setStatus('success');
      ...
      try {
        ...
        console.warn('⚠️ [WhoopCallback] Initial sync failed:', syncError);
      ...
      console.error('❌ [WhoopCallback] Error:', error);
      setStatus('error');
