    ...
    <div className="text-center space-y-6">
      ...
      <div className="space-y-3">
        <h2 className="text-3xl font-bold bg-gradient-to-r from-primary to-purple-500 bg-clip-text text-transparent">
          Добро пожаловать в Привычки 3.0!
        </h2>
        <p className="text-lg text-muted-foreground max-w-xl mx-auto">
          Улучшенная система отслеживания привычек с умной организацией, 
          геймификацией и удобными жестами
        </p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h3 className="text-2xl font-bold mb-3">Умная организация по времени</h3>
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">
          Используйте свайп-жесты для быстрого взаимодействия с привычками
        </p>
      </div>
...
function Step4ViewModes() {
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h3 className="text-2xl font-bold mb-3">Разные режимы просмотра</h3>
        <p className="text-muted-foreground">
          Выбирайте удобный для вас способ отображения привычек
        </p>
      </div>
    ...
    <div className="text-center space-y-6">
      ...
      <div className="space-y-3">
        <h3 className="text-2xl font-bold bg-gradient-to-r from-yellow-500 via-purple-500 to-pink-500 bg-clip-text text-transparent">
          Зарабатывайте XP и повышайте уровень!
        </h3>
        <p className="text-muted-foreground max-w-xl mx-auto">
          Превратите развитие привычек в увлекательную игру
        </p>
      </div>
