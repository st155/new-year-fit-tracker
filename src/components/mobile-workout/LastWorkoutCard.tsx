...
export function LastWorkoutCard({ workout, onRepeat, onClick }: LastWorkoutCardProps) {
  if (!workout) {
    return (
      ...
      >
        ...
        <p className="text-muted-foreground">Нет записанных тренировок</p>
  ...
  const timeAgo = formatDistanceToNow(workout.date, { addSuffix: true, locale: ru });
