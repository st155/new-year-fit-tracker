    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      {excellent > 0 && (
        ...
        >
          ...
          <span className="text-xs font-medium">{t('dataQuality.excellent')}</span>
      ...
      {good > 0 && (
        ...
        >
          ...
          <span className="text-xs font-medium">{t('dataQuality.good')}</span>
      ...
      {fair > 0 && (
        ...
        >
          ...
          <span className="text-xs font-medium">{t('dataQuality.fair')}</span>
      ...
      {poor > 0 && (
        ...
        >
          ...
          <span className="text-xs font-medium">{t('dataQuality.poor')}</span>
